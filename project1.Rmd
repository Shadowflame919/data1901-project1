...
It is discovered that two seperate metrics for the same factor, employment, can reveal well-rounded categories like education, yet also produce conflicting results in others fields. This emphasises the importance in considering a range of variables when selecting a major, and not taking any one factor at its face value. <br> <br>
...
Another, less direct measure of a major benifits in relation to employment, is to compare the percentage of employed people who require their degree, compared to those employed who do not. That which this report will further refer to as the degree's 'usefulness'.
...
```
Even though this plot is attempting to answer the same question but from a different angle, categories like IACS seem to reveal conflicting results. Education on the other hand leads on both metrics.
