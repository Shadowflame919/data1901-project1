...
Things:
Compare popularity data with results from analysis of median income (Q1) and employment (Q2)
Does the number of people doing these majors align with the these two metrics?
Are there any outlier majors? i.e. Are some majors which have good/bad income & employablity low/high in popularity?
This could be determined though some plots, as employability/income increases so should popularity right?
Although probably not because thats how supply/demand works lol
Suggest some good/bad majors based on this data
